...
class Forces:
    ...
    def get_force(self, x_state, flap_ext, tStamp) -> np.array(3):
    ...
    def aerodynamic_drag_force(self, x_state, flap_ext) -> np.array(3):
        z = x_state[0]
        vel = x_state[1]
        v_mag = np.norm(vel)
    ...
    def gravitational_force(self, altitude, tStamp) -> np.array(3):
        # F = GMm/r^2
    ...
    def wind_force(self, altitude, tStamp) -> np.array(3):
