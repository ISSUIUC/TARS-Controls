...
def plotter(sim_dict, sensor_dict=0, kalman_dict=0):
    ...
    pos_error_nc.plot(kalman_dict["time"], 3*np.sqrt(kalman_dict["pos_cov"][:,0]), label="3$\sigma$", color="tab:red", linestyle = "dashed",linewidth = 1);
    ...
    pos_error_nc.plot(kalman_dict["time"], 3*np.sqrt(kalman_dict["pos_cov"][:,1]), label="3$\sigma$", color="tab:green", linestyle = "dashed",linewidth = 1);
    ...
    pos_error_nc.plot(kalman_dict["time"], 3*np.sqrt(kalman_dict["pos_cov"][:,2]), label="3$\sigma$", color="tab:blue", linestyle = "dashed",linewidth = 1);
    ...
    vel_error_nc.plot(kalman_dict["time"], 3*np.sqrt(kalman_dict["vel_cov"][:,0]), label="3$\sigma$", color="tab:red", linestyle = "dashed",linewidth = 1);
    ...
    vel_error_nc.plot(kalman_dict["time"], 3*np.sqrt(kalman_dict["vel_cov"][:,1]), label="3$\sigma$", color="tab:green", linestyle = "dashed",linewidth = 1);
    ...
    vel_error_nc.plot(kalman_dict["time"], 3*np.sqrt(kalman_dict["vel_cov"][:,2]), label="3$\sigma$", color="tab:blue", linestyle = "dashed",linewidth = 1);
    ...
    accel_error_nc.plot(kalman_dict["time"], 3*np.sqrt(kalman_dict["accel_cov"][:,0]), label="3$\sigma$", color="tab:red", linestyle = "dashed",linewidth = 1);
    ...
    accel_error_nc.plot(kalman_dict["time"], 3*np.sqrt(kalman_dict["accel_cov"][:,1]), label="3$\sigma$", color="tab:green", linestyle = "dashed",linewidth = 1);
    ...
    accel_error_nc.plot(kalman_dict["time"], 3*np.sqrt(kalman_dict["accel_cov"][:,2]), label="3$\sigma$", color="tab:blue", linestyle = "dashed",linewidth = 1);
