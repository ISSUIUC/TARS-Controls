...
def readData () :
    ...
    df = pandas.read_csv("Simulation/6DOF_RK4/LookUp/data.csv" ,
...
def plotGraph (measuredDict):
    ...
    df_lowG_timestamp = list(measuredDict['timestamp'].values())[:10000]
    # df_lowG_timestamp= df_lowG_timestamp[0:1000]
    df_barometer_data = list(measuredDict['barometer.altitude'].values())[:10000]
