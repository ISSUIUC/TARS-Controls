...
# Created 07/31/2021
#
# Kinematics model based heavily on the following literature:
#   Master of Science Thesis
#   Real-time poosition and attitude determination of the Stratos II sound rocket
#   Bryan Tong Minh
#
# This file attempts to derive an Extended Kalman Filter to estimate the rocket's
# location and velocity along with correction factors for parameters like drag 
# coefficient, static roll moment, and thrust force.
# 
# Authors:
# Ayberk Yaraneri
#
